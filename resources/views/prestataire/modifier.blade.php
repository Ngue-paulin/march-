...
<div class="container">
    <div class="col-md-20 justify expand-block">
        <div class="card">
            <div class="card-header"><strong>{{ __('Modifier Une Information') }}</strong></div>
               ...
               <div></div>
            <div class="card-body">
                <form method="POST" action="{{ route('prestataires.update' , $prestataire) }}" novalidate>
                    {{csrf_field()}}
                    {{ method_field('PUT')}}
            ...
            <div  class="form-group slot-start col-md-6 align-left">
                    <div class="form-group row has-error">
                            ...
                            <div class="input-field col s5">
                                 <input name="nom" id="nom" type="text" class="form-control validate"  value="{{ old('nom') ?? $prestataire->nom }}" required="required" autocomplete="reference" autofocus>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="input-field col s5">
                                 <input name="entreprise" id="entreprise" type="text" class="form-control" value="{{ old('entreprise') ?? $prestataire->entreprise }}" required="required" autocomplete="entreprise" autofocus>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="input-field col s5">
                                 <input id="responsable" type="text" class="form-control validate" name="responsable" value="{{ old('responsable') ?? $prestataire->responsable }}" required="required" autocomplete="responsable" autofocus>
                   ...
                   <div class="form-group row">
                        ...
                        <div class="input-field col s5">
                             <input id="profession" type="text" class="form-control validate @error('profession') is-invalid @enderror" name="profession" value="{{ old('profession') ?? $prestataire->profession}}" required="required" autocomplete="profession" autofocus>
                   ...
                   <div class="form-group row">
                        ...
                        <div class="input-field col s5">
                             <input id="secteur_activite" type="text" class="form-control validate" name="secteur_activite" value="{{ old('secteur_activite') ?? $prestataire->secteur_activite }}" required="required" autocomplete="secteur_activite" autofocus>
                   ...
                   <div class="form-group row">
                        ...
                        <div class="input-field col s5">
                             <input id="tel" type="text" class="form-control validate" name="tel" value="{{ old('tel') ?? $prestataire->tel }}" required="required" autocomplete="tel" autofocus>
             ...
             <div  class="form-group slot-end col-md-6 align-right">
                        <div class="form-group row has-error">
                                ...
                                <div class="input-field col s5">
                                     <input name="email" id="email" type="text" class="form-control validate"  value="{{ old('email') ?? $prestataire->email }}" required="required" autocomplete="reference" autofocus>
                        ...
                        <div class="form-group row">
                                <label class="col-md-4 col-form-label text-md-right" style="color:blue" for="cni" >{{ __('N° cni') ?? $prestataire->cni }}</label>
                                <div class="input-field col s5">
                                     <input name="cni" id="cni" type="text" class="form-control validate" value="{{ old('cni') ?? $prestataire->cni }}" required="required" autocomplete="cni"  autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                     <input name="ville" id="ville" type="text" class="form-control" value="{{ old('ville') ?? $prestataire->ville }}" required="required" autocomplete="financement" autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                     <input id="boite_postale" type="text" class="form-control validate" name="boite_postale" value="{{ old('boite_postale') ?? $prestataire->boite_postale }}" required="required" autocomplete="boite_postale" autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                    <input id="numero_contrib" type="text" class="form-control" name="numero_contrib" value="{{ old('numero_contrib') ?? $prestataire->numero_contrib }}" required="required" autocomplete="numero_contrib">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                     <input id="numero_rg" type="text" class="form-control validate" name="numero_rg" value="{{ old('numero_rg') ?? $prestataire->numero_rg }}" required="required" autocomplete="numero_rg">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                     <input id="numero_compbanck" type="text" class="form-control validate" name="numero_compbanck" value="{{ old('numero_compbanck') ?? $prestataire->numero_compbanck }}" required="required" autocomplete="numero_compbanck">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                     <input id="banck" type="text" class="form-control validate" name="banck" value="{{ old('banck') ?? $prestataire->banck }}" required="required" autocomplete="banck">
