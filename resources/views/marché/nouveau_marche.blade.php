...
<div class="container">
    <div class="col-md-20 justify expand-block">
        <div class="card">
            <div class="card-header"><h3>{{ __('Ajouter Un Nouvau Marché') }}</h3></div>
        <div class="col-md-10 col-form-label text-md-right mb-4" style="color: cyan"><h3>Remplissez Correctement Les Informations Suivantes!!!</h3></div>
            <div class="card-body">
                <form method="POST" action="{{ route('marches.store') }} " novalidate>
                    {{csrf_field()}}
            ...
            <div  class="form-group slot-start col-md-6 align-left">
                    <div class="form-group row has-error">
                            ...
                            <div class="input-field col s5">
                                 <input name="reference" id="reference" type="text" class="form-control validate"  value="{{ old('reference') }}" required="required" autocomplete="reference" autofocus>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="input-field col s5">
                                 <input name="secteur_marche" id="secteur_marche" type="text" class="form-control validate" required="required" autocomplete="secteur_marche"  autofocus>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="input-field col s5">
                                 <input name="date_debut" id="date_debut" type="date" class="form-control" value="{{ old('date_debut') }}" required="required" autocomplete="date_debut" autofocus>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="input-field col s5">
                                 <input id="date_fin" type="date" class="form-control validate" name="date_fin" value="{{ old('date_fin') }}" required="required" autocomplete="date_fin" autofocus>
                   ...
                   <div class="form-group row">
                        ...
                        <div class="input-field col s5">
                             <input id="type_marche" type="text" class="form-control validate" name="type_marche" value="{{ old('type_marche') }}" required="required" autocomplete="type_marche" autofocus>
                   ...
                   <div class="form-group row">
                        ...
                        <div class="input-field col s5">
                             <input id="montant" type="text" class="form-control validate" name="montant" value="{{ old('montant') }}" required="required" autocomplete="montant" autofocus>
             ...
             <div  class="form-group slot-end col-md-6 align-right">
                        <div class="form-group row has-error">
                                ...
                                <div class="input-field col s5">
                                     <input name="delai_livreson" id="delai_livreson" type="text" class="form-control validate"  value="{{ old('delai_livreson') }}" required="required" autocomplete="reference" autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                     <input name="lieu_livreson" id="lieu_livreson" type="text" class="form-control validate" required="required" autocomplete="lieu_livreson"  autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                     <input name="financement" id="financement" type="text" class="form-control" value="{{ old('financement') }}" required="required" autocomplete="financement" autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                     <input id="imputation" type="text" class="form-control validate" name="imputation" value="{{ old('imputation') }}" required="required" autocomplete="imputation" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-field col s5">
                                     <input id="maitre_oeuvre" type="text" class="form-control validate" name="maitre_oeuvre" required="required" autocomplete="maitre_oeuvre">
